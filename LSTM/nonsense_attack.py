...
def train(exp_path, injection_rate, beam_size, qsize):
    print("Start Qsize: ", beam_size)
    train_dataloader, validation_dataloader, p_validation_dataloader = getDataloader(injection_rate, beam_size, qsize)
...
if __name__ == "__main__":
    injection_rate = 0.01
    for beam_size in [1, 5, 8, 10, 12, 15]:
        qsize = beam_size * 200
        if beam_size == 1:
        ...
        train(exp_path, injection_rate, beam_size, qsize)
